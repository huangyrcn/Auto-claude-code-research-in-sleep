...
>
> **How it differs from EXPERIMENT_TRACKER.md:** The tracker (in `research/refine/`) is an execution checklist (TODO → RUNNING → DONE). This log is a permanent record with full results, configs, and reproduction commands. The tracker tells you what's left to do; the log tells you what was done and what it showed.
>
...
**Date**: YYYY-MM-DD
**Idea**: [Which idea from research/IDEA_CANDIDATES.md]
