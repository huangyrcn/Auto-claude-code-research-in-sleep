...
> **Tip:** If context is too long, split each stage into separate conversations and pass results via files (e.g., `research/IDEA_REPORT.md`, `research/refine/FINAL_PROPOSAL.md`).
...
Read research/refine/EXPERIMENT_PLAN.md and implement experiments.
...
|--------|-----------|--------------|
| 1 | Idea Discovery: Use `idea-discovery` skill + research direction | `research/IDEA_REPORT.md`, `research/refine/FINAL_PROPOSAL.md`, `research/refine/EXPERIMENT_PLAN.md` |
| 2 | Experiment Bridge: Use `experiment-bridge` skill | Experiment scripts and results |
| 3 | Auto Review: Use `auto-review-loop` skill | `research/AUTO_REVIEW.md` |
...
|---|---|---|
| `research/REVIEW_STATE.json` | Tracks auto-review progress | auto-review-loop |
| `research/AUTO_REVIEW.md` | Cumulative review log | auto-review-loop |
| `research/IDEA_REPORT.md` | Ranked ideas and initial findings | idea-discovery |
