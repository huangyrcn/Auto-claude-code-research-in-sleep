...
> **提示：** 如果上下文过长，可以将每个阶段拆分为单独的对话，通过文件（如 `research/IDEA_REPORT.md`、`research/refine/FINAL_PROPOSAL.md`）传递结果。
...
| 阶段 | 执行方式 | 产出文件 |
|------|---------|---------|
| 1 | 创意发现：使用 `idea-discovery` 技能 + 研究方向 | `research/IDEA_REPORT.md`, `research/refine/FINAL_PROPOSAL.md`, `research/refine/EXPERIMENT_PLAN.md` |
| 2 | 实验桥接：使用 `experiment-bridge` 技能 | 实验脚本与结果 |
| 3 | 自动评审：使用 `auto-review-loop` 技能 | `research/AUTO_REVIEW.md` |
...
| 文件 | 作用 | 典型流程 |
|---|---|---|
| `research/REVIEW_STATE.json` | 记录自动审阅进度 | auto-review-loop |
| `research/AUTO_REVIEW.md` | 累计审阅日志 | auto-review-loop |
| `research/IDEA_REPORT.md` | 创意筛选与初评结果 | idea-discovery |
