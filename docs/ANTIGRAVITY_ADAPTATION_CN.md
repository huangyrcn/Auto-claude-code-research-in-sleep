...
- 后台任务: `tmux new-session -d -s aris-exp0 "bash -lc '...'"`

## 研究项目

- 课题: [你的研究方向]
- 目标会议: ICLR/NeurIPS/ICML
- 关键文件: NARRATIVE_REPORT.md, research/IDEA_REPORT.md
```
...
读取 research/refine/EXPERIMENT_PLAN.md 并实现实验。
...
| 阶段 | 执行方式 | 产出文件 |
|------|---------|---------|
| 1 | 创意发现：`skills/idea-discovery/SKILL.md` + 研究方向 | `research/IDEA_REPORT.md`, `research/refine/FINAL_PROPOSAL.md`, `research/refine/EXPERIMENT_PLAN.md` |
| 2 | 实验桥接：`skills/experiment-bridge/SKILL.md` | 实验脚本与结果 |
| 3 | 自动评审：`skills/auto-review-loop/SKILL.md` | `research/AUTO_REVIEW.md` |
...
| 文件 | 作用 | 对应流程 |
|------|------|---------|
| `research/REVIEW_STATE.json` | 自动评审进度 | auto-review-loop |
| `research/AUTO_REVIEW.md` | 累计评审日志 | auto-review-loop |
| `research/IDEA_REPORT.md` | 创意筛选与排名 | idea-discovery |
| `PAPER_PLAN.md` | 论文大纲 + claim-evidence matrix | paper-plan |
| `research/refine/FINAL_PROPOSAL.md` | 精化后的方法提案 | research-refine |
| `research/refine/EXPERIMENT_PLAN.md` | 实验路线图 | experiment-plan |

中断恢复示例：

```
读取 skills/auto-review-loop/SKILL.md，然后读取 research/REVIEW_STATE.json 和 research/AUTO_REVIEW.md。
从保存的状态恢复自动评审循环。
```
...
- `research/IDEA_REPORT.md` → implementation plan artifact
- `research/AUTO_REVIEW.md` → walkthrough artifact
