...
- **OUTPUT_DIR = `research/refine/`** — Default destination for experiment planning artifacts.
...
#### Step 5.1: Write `research/refine/EXPERIMENT_PLAN.md`
...
#### Step 5.2: Write `research/refine/EXPERIMENT_TRACKER.md`
...
Plan file: research/refine/EXPERIMENT_PLAN.md
Tracker file: research/refine/EXPERIMENT_TRACKER.md
```
