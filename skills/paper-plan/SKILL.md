...
5. **Compact files** (if available): `research/IDEA_CANDIDATES.md`, `research/findings.md`, `research/EXPERIMENT_LOG.md` — preferred over full files when present, saves context window
